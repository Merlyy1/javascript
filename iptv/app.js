...
// // const certStream = fsp.readFile('certStream.pem');
// // const httpsAgent = new https.Agent({
// //     ca: certStream // On ajoute le certificat du streamer comme CA de confiance
// // });
...
//     let ChaineAbonne = []; //permettant de connaitre les chaines attribué
...
//     if (abonnement === 'Gratuit')
//     {
//     console.log("\n\nL'abonné(e) " + prenom + ', aura le droit au chaîne suivante : ', ChaineAbonne);
//     }
//     else if (abonnement === 'Premium')
//     {
//     console.log("\n\nL'abonné(e) " + prenom + ', aura le droit au chaîne suivante : ', ChaineAbonne);
